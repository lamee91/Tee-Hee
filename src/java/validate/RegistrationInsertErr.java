...
public class RegistrationInsertErr {
    ...
    public RegistrationInsertErr(String emailIsEmpty, String emailIsExisted, String passwordIsEmpty, String firstNameIsEmpty, String lastNameIsEmpty, String phoneIsEmpty, String confirmPasswordNotValid) {
